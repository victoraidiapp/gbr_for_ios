...
sendOrder:function(){
    ...
    LocalFileManager.writePDF(customer.nombre,output,function(r){
                              ...
                              console.log("Vamos a esperar 2 segundos");
                              setTimeout(function(){
                                         console.log("Ahora vamos a mandar el archivo al mail "+r);
                                         ...
                                         plugin.email.open({
                                                           ...
                                                           isHtml:true,
                                                           body:'<p>Envío de albarán de pedido realizado desde la app de Gahibre para ios</p>'
                                                           });
                                         LoadingDialog.hide();
                                         //Vaciamos el carrito
