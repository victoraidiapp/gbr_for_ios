...
(function($) {
  ...
  $(function() {
    ...
    $('body').on('singletap', '.button', function() {
		console.log("Has picado en un boton");
      var $this = $(this);
  ...
  $.extend({
    ...
    UITabbar : function ( options ) {
      ...
      */
	  ...
	  console.log("Asociamos la función singletap tabbar");
      $('body').find('.tabbar').on('singletap', '.button', function() {
		  /*HACK TO INTERCEPTATE PRE-EXECUTE*/
		  console.log("Has picado en un botón cuyo nav-pre-execute es "+$(this).data('nav-pre-execute'));
		  if(typeof($(this).data('nav-pre-execute'))!='undefined'){
			  console.log("Se ha definido una función de pre ejecución");
			  var resultado=eval($(this).data('nav-pre-execute')+'()');
			  console.log(" El resultado de la función "+$(this).data('nav-pre-execute')+'() es '+resultado);
			if(resultado!=false){
			console.log("Detenemos la propagación");
			return false;	
			}
		  }
        var $this = this;
		...
		$('article.current').trigger('navigationend');
      });
    }
  });
  $.extend({
